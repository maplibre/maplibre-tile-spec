...
public class IntegerEncoder {
    ...
    public static byte[] encodeMortonStream(List<Integer> values, int numBits, int coordinateShift, PhysicalLevelTechnique physicalLevelTechnique){
        var encodedValueStream = encodeMortonCodes(values, physicalLevelTechnique);
        var valuesMetadata = new MortonEncodedStreamMetadata(PhysicalStreamType.DATA, new LogicalStreamType(DictionaryType.MORTON),
                encodedValueStream.logicalLevelTechnique1, encodedValueStream.logicalLevelTechnique2, physicalLevelTechnique,
                encodedValueStream.physicalLevelEncodedValuesLength, encodedValueStream.encodedValues.length,
    ...
    public static byte[] encodeIntStream(List<Integer> values, PhysicalLevelTechnique physicalLevelTechnique, boolean isSigned,
                                         PhysicalStreamType streamType, LogicalStreamType logicalStreamType){
        ...
        var streamMetadata = (encodedValueStream.logicalLevelTechnique1 == LogicalLevelTechnique.RLE ||
            encodedValueStream.logicalLevelTechnique2 == LogicalLevelTechnique.RLE)?
                new RleEncodedStreamMetadata(streamType, logicalStreamType, encodedValueStream.logicalLevelTechnique1,
                    encodedValueStream.logicalLevelTechnique2, physicalLevelTechnique,
                    encodedValueStream.physicalLevelEncodedValuesLength, encodedValueStream.encodedValues.length,
                    encodedValueStream.numRuns, values.size()) :
                new StreamMetadata(streamType, logicalStreamType, encodedValueStream.logicalLevelTechnique1,
                        encodedValueStream.logicalLevelTechnique2, physicalLevelTechnique,
                        encodedValueStream.physicalLevelEncodedValuesLength, encodedValueStream.encodedValues.length);
    ...
    public static byte[] encodeLongStream(List<Long> values, boolean isSigned, PhysicalStreamType streamType,
        ...
        var streamMetadata = (encodedValueStream.logicalLevelTechnique1 == LogicalLevelTechnique.RLE ||
                encodedValueStream.logicalLevelTechnique2 == LogicalLevelTechnique.RLE)?
                new RleEncodedStreamMetadata(streamType, logicalStreamType, encodedValueStream.logicalLevelTechnique1,
                        encodedValueStream.logicalLevelTechnique2, PhysicalLevelTechnique.VARINT,
                        encodedValueStream.physicalLevelEncodedValuesLength, encodedValueStream.encodedValues.length,
                        encodedValueStream.numRuns, values.size()) :
                new StreamMetadata(streamType, logicalStreamType, encodedValueStream.logicalLevelTechnique1,
                        encodedValueStream.logicalLevelTechnique2, PhysicalLevelTechnique.VARINT,
    ...
    public static IntegerEncodingResult encodeMortonCodes(List<Integer> values,
        ...
        var encodedValues = physicalLevelTechnique == PhysicalLevelTechnique.FAST_PFOR? encodeFastPfor(deltaValues, false) :
                encodeVarint(deltaValues.stream().mapToLong(i -> i).boxed().collect(Collectors.toList()), false);

...
struct Unroller {
    ...
    static void Unpack(const uint32_t* __restrict__& in, uint64_t* __restrict__ out) {
        unpack_single_out<DELTA, (DELTA * OINDEX) % 32>(in, out + OINDEX);
    ...
    static void Pack(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    ...
    static void PackNoMask(const uint32_t* __restrict__ in, uint32_t* __restrict__ out) {
        pack_single_in<DELTA, (DELTA * OINDEX) % 32, static_cast<uint32_t>(-1)>(in[OINDEX], out);

        Unroller<DELTA, OINDEX + 1>::PackNoMask(in, out);
    }

    static void PackNoMask(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
        pack_single_in64<DELTA, (DELTA * OINDEX) % 32, static_cast<uint64_t>(-1)>(in[OINDEX], out);
...
struct Unroller<DELTA, 31> {
    ...
    static void Unpack(const uint32_t* __restrict__ in, uint32_t* __restrict__ out) { out[31] = (*in) >> SHIFT; }
    ...
    static void Pack(const uint32_t* __restrict__ in, uint32_t* __restrict__ out) { *out |= (in[31] << SHIFT); }
    ...
    static void PackNoMask(const uint32_t* __restrict__ in, uint32_t* __restrict__ out) { *out |= (in[31] << SHIFT); }
...
void __fastpackwithoutmask0(const uint64_t* __restrict__, uint32_t* __restrict__) {}
...
void __fastunpack10(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<10>::Unpack(in, out);
}

void __fastunpack11(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<11>::Unpack(in, out);
}

void __fastunpack12(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<12>::Unpack(in, out);
}

void __fastunpack13(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<13>::Unpack(in, out);
}

void __fastunpack14(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<14>::Unpack(in, out);
}

void __fastunpack15(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<15>::Unpack(in, out);
}

void __fastunpack16(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    for (uint32_t outer = 0; outer < 16; ++outer) {
        for (uint32_t inwordpointer = 0; inwordpointer < 32; inwordpointer += 16) {
            *(out++) = ((*in) >> inwordpointer) % (1U << 16);
}
...
void __fastunpack17(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<17>::Unpack(in, out);
}

void __fastunpack18(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<18>::Unpack(in, out);
}

void __fastunpack19(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<19>::Unpack(in, out);
}

void __fastunpack20(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<20>::Unpack(in, out);
}

void __fastunpack21(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<21>::Unpack(in, out);
}

void __fastunpack22(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<22>::Unpack(in, out);
}

void __fastunpack23(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<23>::Unpack(in, out);
}

void __fastunpack24(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<24>::Unpack(in, out);
}

void __fastunpack25(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<25>::Unpack(in, out);
}

void __fastunpack26(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<26>::Unpack(in, out);
}

void __fastunpack27(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<27>::Unpack(in, out);
}

void __fastunpack28(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<28>::Unpack(in, out);
}

void __fastunpack29(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<29>::Unpack(in, out);
}

void __fastunpack30(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<30>::Unpack(in, out);
}

void __fastunpack31(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<31>::Unpack(in, out);
}
...
void __fastunpack34(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<34>::Unpack(in, out);
}

void __fastunpack35(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<35>::Unpack(in, out);
}

void __fastunpack36(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<36>::Unpack(in, out);
}

void __fastunpack37(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<37>::Unpack(in, out);
}

void __fastunpack38(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<38>::Unpack(in, out);
}

void __fastunpack39(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<39>::Unpack(in, out);
}

void __fastunpack40(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<40>::Unpack(in, out);
}

void __fastunpack41(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<41>::Unpack(in, out);
}

void __fastunpack42(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<42>::Unpack(in, out);
}

void __fastunpack43(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<43>::Unpack(in, out);
}

void __fastunpack44(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<44>::Unpack(in, out);
}

void __fastunpack45(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<45>::Unpack(in, out);
}

void __fastunpack46(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<46>::Unpack(in, out);
}

void __fastunpack47(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<47>::Unpack(in, out);
}

void __fastunpack48(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<48>::Unpack(in, out);
}

void __fastunpack49(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<49>::Unpack(in, out);
}

void __fastunpack50(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<50>::Unpack(in, out);
}

void __fastunpack51(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<51>::Unpack(in, out);
}

void __fastunpack52(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<52>::Unpack(in, out);
}

void __fastunpack53(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<53>::Unpack(in, out);
}

void __fastunpack54(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<54>::Unpack(in, out);
}

void __fastunpack55(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<55>::Unpack(in, out);
}

void __fastunpack56(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<56>::Unpack(in, out);
}

void __fastunpack57(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<57>::Unpack(in, out);
}

void __fastunpack58(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<58>::Unpack(in, out);
}

void __fastunpack59(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<59>::Unpack(in, out);
}

void __fastunpack60(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<60>::Unpack(in, out);
}

void __fastunpack61(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<61>::Unpack(in, out);
}

void __fastunpack62(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<62>::Unpack(in, out);
}

void __fastunpack63(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    Unroller<63>::Unpack(in, out);
}

void __fastunpack64(const uint32_t* __restrict__ in, uint64_t* __restrict__ out) {
    for (int k = 0; k < 32; ++k) {
        out[k] = in[k * 2];
...
void __fastpackwithoutmask1(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<1>::PackNoMask(in, out);
}

void __fastpackwithoutmask2(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<2>::PackNoMask(in, out);
}

void __fastpackwithoutmask3(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<3>::PackNoMask(in, out);
}

void __fastpackwithoutmask4(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<4>::PackNoMask(in, out);
}

void __fastpackwithoutmask5(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<5>::PackNoMask(in, out);
}

void __fastpackwithoutmask6(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<6>::PackNoMask(in, out);
}

void __fastpackwithoutmask7(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<7>::PackNoMask(in, out);
}

void __fastpackwithoutmask8(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<8>::PackNoMask(in, out);
}

void __fastpackwithoutmask9(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<9>::PackNoMask(in, out);
}

void __fastpackwithoutmask10(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<10>::PackNoMask(in, out);
}

void __fastpackwithoutmask11(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<11>::PackNoMask(in, out);
}

void __fastpackwithoutmask12(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<12>::PackNoMask(in, out);
}

void __fastpackwithoutmask13(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<13>::PackNoMask(in, out);
}

void __fastpackwithoutmask14(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<14>::PackNoMask(in, out);
}

void __fastpackwithoutmask15(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<15>::PackNoMask(in, out);
}

void __fastpackwithoutmask16(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<16>::PackNoMask(in, out);
}

void __fastpackwithoutmask17(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<17>::PackNoMask(in, out);
}

void __fastpackwithoutmask18(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<18>::PackNoMask(in, out);
}

void __fastpackwithoutmask19(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<19>::PackNoMask(in, out);
}

void __fastpackwithoutmask20(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<20>::PackNoMask(in, out);
}

void __fastpackwithoutmask21(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<21>::PackNoMask(in, out);
}

void __fastpackwithoutmask22(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<22>::PackNoMask(in, out);
}

void __fastpackwithoutmask23(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<23>::PackNoMask(in, out);
}

void __fastpackwithoutmask24(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<24>::PackNoMask(in, out);
}

void __fastpackwithoutmask25(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<25>::PackNoMask(in, out);
}

void __fastpackwithoutmask26(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<26>::PackNoMask(in, out);
}

void __fastpackwithoutmask27(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<27>::PackNoMask(in, out);
}

void __fastpackwithoutmask28(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<28>::PackNoMask(in, out);
}

void __fastpackwithoutmask29(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<29>::PackNoMask(in, out);
}

void __fastpackwithoutmask30(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<30>::PackNoMask(in, out);
}

void __fastpackwithoutmask31(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<31>::PackNoMask(in, out);
}

void __fastpackwithoutmask32(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    for (int i = 0; i < 32; ++i) {
        out[i] = static_cast<uint32_t>(in[i]);
    }
}

void __fastpackwithoutmask33(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<33>::PackNoMask(in, out);
}

void __fastpackwithoutmask34(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<34>::PackNoMask(in, out);
}

void __fastpackwithoutmask35(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<35>::PackNoMask(in, out);
}

void __fastpackwithoutmask36(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<36>::PackNoMask(in, out);
}

void __fastpackwithoutmask37(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<37>::PackNoMask(in, out);
}

void __fastpackwithoutmask38(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<38>::PackNoMask(in, out);
}

void __fastpackwithoutmask39(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<39>::PackNoMask(in, out);
}

void __fastpackwithoutmask40(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<40>::PackNoMask(in, out);
}

void __fastpackwithoutmask41(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<41>::PackNoMask(in, out);
}

void __fastpackwithoutmask42(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<42>::PackNoMask(in, out);
}

void __fastpackwithoutmask43(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<43>::PackNoMask(in, out);
}

void __fastpackwithoutmask44(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<44>::PackNoMask(in, out);
}

void __fastpackwithoutmask45(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<45>::PackNoMask(in, out);
}

void __fastpackwithoutmask46(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<46>::PackNoMask(in, out);
}

void __fastpackwithoutmask47(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<47>::PackNoMask(in, out);
}

void __fastpackwithoutmask48(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<48>::PackNoMask(in, out);
}

void __fastpackwithoutmask49(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<49>::PackNoMask(in, out);
}

void __fastpackwithoutmask50(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<50>::PackNoMask(in, out);
}

void __fastpackwithoutmask51(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<51>::PackNoMask(in, out);
}

void __fastpackwithoutmask52(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<52>::PackNoMask(in, out);
}

void __fastpackwithoutmask53(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<53>::PackNoMask(in, out);
}

void __fastpackwithoutmask54(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<54>::PackNoMask(in, out);
}

void __fastpackwithoutmask55(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<55>::PackNoMask(in, out);
}

void __fastpackwithoutmask56(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<56>::PackNoMask(in, out);
}

void __fastpackwithoutmask57(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<57>::PackNoMask(in, out);
}

void __fastpackwithoutmask58(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    Unroller<58>::PackNoMask(in, out);
}

void __fastpackwithoutmask59(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
...
void __fastpackwithoutmask64(const uint64_t* __restrict__ in, uint32_t* __restrict__ out) {
    for (int i = 0; i < 32; ++i) {
        out[2 * i] = static_cast<uint32_t>(in[i]);
        out[(2 * i) + 1] = in[i] >> 32;
    }

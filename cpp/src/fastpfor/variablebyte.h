...
class VariableByte : public IntegerCODEC {
 public:
  ...
  const uint32_t *decodeArray(const uint32_t *in, const size_t length,
    ...
    decodeFromByteArray<uint32_t>(reinterpret_cast<const uint8_t *>(in),
  ...
  const uint32_t *decodeArray(const uint32_t *in, const size_t length,
    ...
    decodeFromByteArray<uint64_t>(reinterpret_cast<const uint8_t *>(in),
                                  length * sizeof(uint32_t), out, nvalue);
    return in + length;
  }
...
class VByte : public IntegerCODEC {
 public:
  ...
  static void encodeToByteArray(const uint32_t *in, const size_t length, uint8_t *bout,
                         size_t &nvalue) {
    const uint8_t *const initbout = bout;
    for (size_t k = 0; k < length; ++k) {
  ...
  const uint32_t *decodeArray(const uint32_t *in, const size_t length,
                              uint32_t *out, size_t &nvalue) override {
    decodeFromByteArray(reinterpret_cast<const uint8_t *>(in), length * sizeof(uint32_t), out,
                        nvalue);
    return in + length;
  }

  static const uint8_t *decodeFromByteArray(const uint8_t *inbyte, const size_t length,

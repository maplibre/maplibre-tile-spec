...
Which streams may use which scheme, and how the choice is encoded, is in the [v1](specification.md) and [v2](specification-v2.md) specifications.
...
!!! NOTE
    ...
    See the [v1](specification.md#string-columns) and [v2](specification-v2.md#string-columns) specifications.

...
The byte layout is in the [v1 specification](specification.md) and the [v2 specification](specification-v2.md).
...
| Tag | Version | Status |
|---|---|---|
| `0x01` | [MLT v1](specification.md) | Stable. Implemented by every shipped encoder and decoder. |

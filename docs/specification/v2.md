...
v2 stores only power-of-two extents.
...
The code is `log2(extent) - 8`:

| Code | `0x0` | `0x1` | ... | `0xF` |
|---|---|---|---|---|
| Extent | $2^8 = 256$ | $2^9 = 512$ | ... | $2^23 = 8388608$ |

Codes above `0xF` are reserved and MUST be rejected if not zero.

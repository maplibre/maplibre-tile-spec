...
public class ConversionConfig {
  ...
  /**
   * Creates a new Builder for ConversionConfig with all default values.
   *
  ...
  public static class Builder {
    ...
    /**
     * Builds the ConversionConfig with the specified parameters.
     *
     * @return A new ConversionConfig instance
     */

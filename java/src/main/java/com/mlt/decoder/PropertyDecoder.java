...
public class PropertyDecoder {
    ...
    public static Object decodePropertyColumn(byte[] data, IntWrapper offset, MltTilesetMetadata.Column column, int numStreams) throws IOException {
        ...
        if(column.hasScalarType()){
            ...
            /*case DOUBLE:{
                ...
                case STRING: {
                    var strValues = StringDecoder.decode(data, offset, numStreams - 1, presentStream, numValues);

...
public class VectorizedFloatDecoder {
    ...
    public static FloatBuffer decodeFloatStream(byte[] data, IntWrapper offset, StreamMetadata streamMetadata) {
        var floatBuffer = ByteBuffer.wrap(data, offset.get(), streamMetadata.byteLength()).
                order(ByteOrder.LITTLE_ENDIAN).asFloatBuffer();
        offset.add(streamMetadata.byteLength());
        return floatBuffer;
    }

    public static FloatBuffer decodeNullableFloatStream(byte[] data, IntWrapper offset, StreamMetadata streamMetadata,

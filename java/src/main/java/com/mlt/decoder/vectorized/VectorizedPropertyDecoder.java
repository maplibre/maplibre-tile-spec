  ...
  public static Vector decodeToRandomAccessFormat(
    ...
    if (column.hasScalarType()) {
      ...
      return switch (scalarType.getPhysicalType()) {
        ...
        case UINT_32, INT_32 -> decodeIntColumn(
            data, offset, column, scalarType, nullabilityBuffer);
        case UINT_64, INT_64 -> decodeLongColumn(
            data, offset, column, nullabilityBuffer, scalarType);
        case FLOAT ->

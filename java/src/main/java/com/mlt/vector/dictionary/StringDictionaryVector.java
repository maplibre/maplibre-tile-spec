...
public class StringDictionaryVector extends VariableSizeVector<String> implements Iterable<String> {
    ...
    public StringDictionaryVector(String name, IntBuffer indexBuffer, IntBuffer lengthBuffer, ByteBuffer dictionaryBuffer) {
        super(name, lengthBuffer, dictionaryBuffer);
        this.indexBuffer = indexBuffer;
    }

    public StringDictionaryVector(String name, BitVector nullabilityBuffer, IntBuffer indexBuffer, IntBuffer lengthBuffer,
     ...
     * in contrast to the VertexDictionary */
    /*
     * filter query
     * -> equal
     * -> not equal
    ...
    /** First occurrence of offset values has to be in ascending order for example the first occurrence of
     * offset 0 has to be before offset 1 */
    @Override

...
public class StringSharedFsstDictionaryVector extends VariableSizeVector<Map<String, String>> {
    ...
    public static StringSharedFsstDictionaryVector createFromOffsetBuffer(String name, IntBuffer offsetBuffer,
                                                                          ByteBuffer dictionaryBuffer,
                                                                          IntBuffer symbolOffsetBuffer,  ByteBuffer symbolTableBuffer,
                                                                      DictionaryDataVector[] dictionaryDataVectors) {
        var vector = new StringSharedFsstDictionaryVector(name, null, dictionaryBuffer, null,
                symbolTableBuffer, dictionaryDataVectors);

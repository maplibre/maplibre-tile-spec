...
package org.maplibre.mlt.decoder.vectorized.fastpfor;

import java.util.Arrays;
import jdk.incubator.vector.*;

/**
 * Vectorized bitpacking routines. This class is a version of the VectorBitPackerTerse class that
 * with less branch instructions.
 *
 * <p>The code is machine generated from VectorBitPackerTerse.java using helper classes.
 */
public class VectorBitPacker {
  ...
  private static final IntVector MASK_1 = IntVector.broadcast(SPECIES_256, (1 << 1) - 1);
  private static final IntVector MASK_2 = IntVector.broadcast(SPECIES_512, (1 << 2) - 1);
  private static final IntVector MASK_3 = IntVector.broadcast(SPECIES_256, (1 << 3) - 1);
  private static final IntVector MASK_4 = IntVector.broadcast(SPECIES_512, (1 << 4) - 1);
  private static final IntVector MASK_5 = IntVector.broadcast(SPECIES_256, (1 << 5) - 1);
  private static final IntVector MASK_6 = IntVector.broadcast(SPECIES_512, (1 << 6) - 1);
  private static final IntVector MASK_7 = IntVector.broadcast(SPECIES_256, (1 << 7) - 1);
  private static final IntVector MASK_8 = IntVector.broadcast(SPECIES_512, (1 << 8) - 1);
  private static final IntVector MASK_9 = IntVector.broadcast(SPECIES_256, (1 << 9) - 1);
  private static final IntVector MASK_10 = IntVector.broadcast(SPECIES_512, (1 << 10) - 1);
  private static final IntVector MASK_11 = IntVector.broadcast(SPECIES_256, (1 << 11) - 1);
  private static final IntVector MASK_12 = IntVector.broadcast(SPECIES_512, (1 << 12) - 1);
  private static final IntVector MASK_13 = IntVector.broadcast(SPECIES_256, (1 << 13) - 1);
  private static final IntVector MASK_14 = IntVector.broadcast(SPECIES_512, (1 << 14) - 1);
  private static final IntVector MASK_15 = IntVector.broadcast(SPECIES_256, (1 << 15) - 1);
  private static final IntVector MASK_16 = IntVector.broadcast(SPECIES_512, (1 << 16) - 1);
  private static final IntVector MASK_17 = IntVector.broadcast(SPECIES_256, (1 << 17) - 1);
  private static final IntVector MASK_18 = IntVector.broadcast(SPECIES_512, (1 << 18) - 1);
  private static final IntVector MASK_19 = IntVector.broadcast(SPECIES_256, (1 << 19) - 1);
  private static final IntVector MASK_20 = IntVector.broadcast(SPECIES_512, (1 << 20) - 1);
  private static final IntVector MASK_21 = IntVector.broadcast(SPECIES_256, (1 << 21) - 1);
  private static final IntVector MASK_22 = IntVector.broadcast(SPECIES_512, (1 << 22) - 1);
  private static final IntVector MASK_23 = IntVector.broadcast(SPECIES_256, (1 << 23) - 1);
  private static final IntVector MASK_24 = IntVector.broadcast(SPECIES_512, (1 << 24) - 1);
  private static final IntVector MASK_25 = IntVector.broadcast(SPECIES_256, (1 << 25) - 1);
  private static final IntVector MASK_26 = IntVector.broadcast(SPECIES_512, (1 << 26) - 1);
  private static final IntVector MASK_27 = IntVector.broadcast(SPECIES_256, (1 << 27) - 1);
  private static final IntVector MASK_28 = IntVector.broadcast(SPECIES_512, (1 << 28) - 1);
  private static final IntVector MASK_29 = IntVector.broadcast(SPECIES_256, (1 << 29) - 1);
  private static final IntVector MASK_30 = IntVector.broadcast(SPECIES_512, (1 << 30) - 1);
  private static final IntVector MASK_31 = IntVector.broadcast(SPECIES_256, (1 << 31) - 1);

  /**
   * Pack 32 integers
   *
   * @param in source array
   * @param inpos position in source array
   * @param out output array
   * @param outpos position in output array
   * @param b number of bits to use per integer
   */
  public static void fastpack(final int[] in, int inpos, final int[] out, int outpos, int b) {
    switch (b) {
      case 0:
        break;
      case 1:
  ...
  static void fastpackNoMask(final int[] in, int inpos, final int[] out, int outpos, int b) {
    switch (b) {
      case 0:
        break;
      case 1:
   ...
   * @param b number of bits to use per integer
   */
  public static void fastunpack(final int[] in, int inpos, final int[] out, int outpos, int b) {
    switch (b) {
      case 0:
  ...
  public static int slowpack(
      final int[] in, int inpos, int inlen, final int[] out, int outpos, int b) {
    if (inlen == 0) return outpos;
    if (b == 32) {
    ...
    for (int i = 0; i < inlen; i++) {
      ...
      l = (32 - r) % b;
      if (c + r >= 32) {
        if (i < inlen - 1 || l != 0) outpos++;
        r = l == 0 ? 0 : b - l;
        if (l != 0) out[outpos] = val >> (b - r);
        c = 0;
      }
    }
    return outpos;
  ...
  public static int slowunpack(
      final int[] in, int inpos, final int[] out, int outpos, int outlen, int b) {
    if (outlen == 0) {
      return inpos;
    }
    if (b == 32) {
    ...
    int i = 0;
    for (; outpos < limit; i++) {
      if (r > 0) out[outpos++] = (val >>> (32 - (b - r))) | ((in[inpos + i] << (b - r)) & mask);
      val = in[inpos + i];
      int j = 0;
      int l = 32 - r;
      int ll = l % b == 0 ? l : l - b;

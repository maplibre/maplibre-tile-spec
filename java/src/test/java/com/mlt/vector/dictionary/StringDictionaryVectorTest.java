...
public class StringDictionaryVectorTest {
    ...
    public void getValueFromBuffer() throws IOException {
        var values = List.of("Test", "Test1", "Test2", "Test4", "Test", "Test4", "Test1", "Test", "Test4");

        var encodedValues = StringEncoder.encode(values, PhysicalLevelTechnique.FAST_PFOR, false);
        var vector = (StringDictionaryVector)VectorizedStringDecoder.decode("test", encodedValues.getRight(), new IntWrapper(0),
                encodedValues.getLeft(), null);

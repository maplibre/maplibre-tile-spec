...
const VARINT_ENCODED_VALUES = new Uint32Array(fs.readFileSync("test/data/realy_varint.bin").buffer);
const FASTPFOR_ENCODED_VALUES = new Uint32Array(fs.readFileSync("test/data/realy_fastpfor.bin").buffer);

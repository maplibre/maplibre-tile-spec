 ...
 *                number of bits to use per numbereger
 */
export function fastpackwithoutmask(input: Uint32Array, inpos: number, output: Uint32Array, outpos: number, bit: number) {
  switch (bit) {
    case 0:
 ...
 */
export function fastunpack(model: { input: Uint32Array, inpos: number, output: Uint32Array, outpos: number, bit: number }) {
  switch (model.bit) {
    case 0:
      fastunpack0(model);
      break;

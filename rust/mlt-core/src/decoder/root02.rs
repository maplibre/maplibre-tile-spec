...
//!                                   only when the presence nibble is Inline
...
use crate::decoder::{
    ColumnType02, DataType02, DictionaryType, GeoLayout, Id, Layer01, LengthType, Presence02,
    RawGeometry, RawId, RawIdValue, RawPresence, RawScalar, StreamType,
};
...
pub(crate) fn parse_layer02<'a>(
    ...
    for _ in 0..column_count {
        ...
        let presence;
        (input, presence) = parse_presence(typ.presence, input, feature_count)?;

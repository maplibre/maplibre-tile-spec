...
use crate::decoder::{ColumnType02, DictionaryType, Extent, GeoLayout, LengthType, StreamType};
...
impl<'a> Walker<'a> {
    ...
    fn walk_column02(
        ...
        let (after_ty, typ_byte) = parse_u8(input)?;
        let typ =
        ...
        self.leaf(
            ...
            after_ty,
            "type".to_string(),
            Some(format!("0x{typ_byte:02X} {typ:?}")),
        );
        ...
        self.relabel(ci, format!("column[{i}] {typ:?}{name_suffix}"));
        ...
        input = self.walk_stream02(input, data, data_count, "data", hint_for(typ))?;
...
/// Decode hint for a column's data stream, keyed by the column type byte.
fn hint_for(typ: ColumnType02) -> DecodeHint {
    use ColumnType02 as C;
    match typ {
        C::Bool | C::OptBool => DecodeHint::Bool,
        C::I8 | C::OptI8 | C::I32 | C::OptI32 => DecodeHint::I32,
        C::Id | C::OptId | C::U8 | C::OptU8 | C::U32 | C::OptU32 => DecodeHint::U32,
        C::I64 | C::OptI64 => DecodeHint::I64,
        C::LongId | C::OptLongId | C::U64 | C::OptU64 => DecodeHint::U64,
        C::F32 | C::OptF32 => DecodeHint::F32,
        C::F64 | C::OptF64 => DecodeHint::F64,
    }
}

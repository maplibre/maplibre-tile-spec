...
use crate::decoder::{
    DictionaryType, FastPForKind, GeometryValues, PhysicalEncoding, RleLayout, StreamType,
};
...
impl EncoderConfig {
    ...
    pub(crate) fn fastpfor(self) -> Option<PhysicalEncoding> {
        self.allow_fastpfor
            .then(|| PhysicalEncoding::FastPFor(self.wire_version.fastpfor_kind()))
    }
    ...
    pub fn allow_shared_dict(self) -> bool {
        ...
        self.allow_shared_dict && self.wire_version == WireVersion::V01
    }

...
fn auto_u32_sequential_picks_delta_rle() {
    ...
    insta::assert_debug_snapshot!(stream.meta, @"StreamMeta { stream_type: Data(None), logical_encoding: DeltaRle(RleMeta { runs: 2, num_rle_values: 100 }), physical_encoding: VarInt, num_values: 4 }");

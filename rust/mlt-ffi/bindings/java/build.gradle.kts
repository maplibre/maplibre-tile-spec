...
mavenPublishing {
    ...
    coordinates("org.maplibre", "mlt-ffi-java", version.toString())

    pom {
        name.set("MapLibre Tile FFI (Java)")
        description.set("Java Panama FFM bindings for the Rust MLT encoder")

...
describe("decodeUnsignedInt32Stream", () => {
  ...
  it("should throw for unsupported PhysicalLevelTechnique", () => {
    ...
    expect(() =>
      decodeUnsignedInt32Stream(data, new IntWrapper(0), metadata),
    ).toThrow("Specified physicalLevelTechnique ALP is not supported (yet).");
  });
  ...
  it("should decode nullable MORTON fully populated", () => {
    ...
    const result = decodeUnsignedInt32Stream(
      data,
      offset,
      metadata,
      undefined,
...
describe("decodeSignedInt32Stream / decodeSignedConstInt32Stream", () => {
  ...
  it("should decode nullable NONE signed Int32 partially populated", () => {
    ...
    const result = decodeSignedInt32Stream(
      data,
      new IntWrapper(0),
      metadata,
      undefined,
  ...
  it("should decode Componentwise Delta Scaled with Int32", () => {
    ...
    const data = encodeSignedInt32Stream(
      expectedValues,
      metadata,
      undefined,
      scalingData,
  ...
  it("should decode nullable RLE Int32 partially populated", () => {
    let metadata = createStreamMetadata(
      LogicalLevelTechnique.RLE,
      LogicalLevelTechnique.NONE,
      2,
    );
  ...
  it("should decode signed const Int32", () => {
    ...
    const result = decodeSignedConstInt32Stream(
      data,
      new IntWrapper(0),
      metadata,
    );
...
describe("decodeUnsignedInt32Stream / decodeUnsignedConstInt32Stream", () => {
  it("should decode unsigned const Int32", () => {
    ...
    const data = encodeUnsignedInt32Stream(
      new Uint32Array([0xffffffff]),
      metadata,
    );

    const result = decodeUnsignedConstInt32Stream(
      data,
      new IntWrapper(0),
      metadata,
    );
  ...
  it("should throw for unsupported technique", () => {
    ...
    ).toThrow("The specified Logical level technique is not supported");
  });
});
...
describe("decodeInt64AsFloat64Stream", () => {
  it("should decode NONE unsigned", () => {
    ...
    const encodedValues = encodeFloat64(
      new Float64Array(expectedValues),
      metadata,
      false,
    );
    const data = encodeVarintFloat64(encodedValues);
    const result = decodeUnsignedInt64AsFloat64Stream(
      data,
      new IntWrapper(0),
      metadata,
    );
  ...
  it("should decode NONE signed", () => {
    ...
    const data = encodeVarintFloat64(encodedValues);
    const result = decodeSignedInt64AsFloat64Stream(
      data,
      new IntWrapper(0),
      metadata,
    );
  ...
  it("should throw for unsupported technique", () => {
    ...
    expect(() =>
      decodeSignedInt64AsFloat64Stream(values, new IntWrapper(0), metadata),
    ).toThrow("The specified Logical level technique is not supported: MORTON");
  });
});
...
describe("decodeInt64Stream", () => {
  ...
  describe("NONE", () => {
    ...
    it("should decode signed const Int64", () => {
      ...
      const result = decodeSignedConstInt64Stream(
        data,
        new IntWrapper(0),
        metadata,
      );
    ...
    it("should decode unsigned const Int64", () => {
      ...
      const data = encodeInt64UnsignedNone(
        new BigInt64Array([0xffffffffffffffffn]),
      );

      const result = decodeUnsignedConstInt64Stream(
        data,
        new IntWrapper(0),
        metadata,
      );
    ...
    it("should decode NONE unsigned with all non-null values", () => {
      ...
      const result = decodeUnsignedInt64Stream(
        data,
        offset,
        metadata,
        bitVector,
  ...
  describe("error handling", () => {
    ...
    it("should throw for unsupported technique with nullable", () => {
      ...
      const bitVector = new BitVector(new Uint8Array([0b00000111]), 3);
      expect(() =>
        decodeSignedInt64Stream(data, offset, metadata, bitVector),
      ).toThrow();
    });
  });
});

...
import { decodeUnsignedIntStream, decodeLengthStreamToOffsetBuffer } from "./integerStreamDecoder";
    ...
    for (let i = 0; i < numStreams; i++) {
        ...
        switch (streamMetadata.physicalStreamType) {
            ...
            case PhysicalStreamType.OFFSET: {
                offsetStream = decodeUnsignedIntStream(data, offset, streamMetadata, undefined, nullabilityBuffer);
                break;
            }
...
export function decodeSharedDictionary(
    ...
    for (const childField of childFields) {
        ...
        const offsetStream = decodeUnsignedIntStream(
            data,
            offset,
